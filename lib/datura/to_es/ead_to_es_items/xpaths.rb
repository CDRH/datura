  ...
  def xpaths_list
      {
        ...
        "date" => "/ead/archdesc/dsc/c01/did/unitdate",
        "description" => "/ead/archdesc/dsc/c01/scopecontent/p",
        ...
        "extent" => "/ead/archdesc/dsc/c01/did/physdesc/extent",
        "format" => "/ead/archdesc/dsc/c01/did/physdesc/physfacet",
        "image_url" => "/ead/archdesc/dsc/c01/dao/@href",
        ...
        "identifier" => "/ead/archdesc/dsc/c01/did/unitid[@type='WWA']",
        ...
        "repository_id" => "/ead/archdes/dsc/c01/did/unitid[@type='repository']",
        ...
        # "text" => "//text",
        "title" => "ead/archdesc/dsc/c01/did/unittitle",
        # "topic" => "/TEI/teiHeader/profileDesc/textClass/keywords[@n='topic']/term",
        "type" => "/ead/archdesc/dsc/c01/did/physdesc/genreform",
