...
module Parser
  def self.argv_projects(argv)
    ...
    if argv.length == 0
      ...
      puts "Captain, sensors detect more than one project requested!".red
      puts @usage
      exit
    end
    return project
