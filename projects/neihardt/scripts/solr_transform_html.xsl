<?xml version="1.0"?>
<!-- This script taken from data repository at scripts/xslt/cdrh_tei_to_html/tei.p5.xsl -->
<xsl:stylesheet 
  ...
  <!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    <xsl:param name="keyword_link"/> <!-- not sure that this is necessary -->
        ...
        <div>
          ...
          <h3>
            <a>
              ...
              <xsl:attribute name="href"><xsl:value-of select="$site_url"/>/search?recipient=<xsl:value-of select="persName[@type='display']"/></xsl:attribute>
              <xsl:value-of select="persName[@type='display']"/>
            </a>
          </h3>
  ...
  <!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    <xsl:template match="note">
      <xsl:choose>
        <xsl:when test="current()/@place='foot'">
          <span>
            <xsl:attribute name="class">
              <xsl:text>foot</xsl:text>
            </xsl:attribute>
        ...
        <xsl:when test="current()/@type='editorial'"/>
